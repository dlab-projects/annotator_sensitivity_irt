"""Runs Facets Scaling Experiment 21.
...
Experiment 21:
    ...
    - Merge Native American and Pacific Islander.
...
data = data[data[keys.target_race_cols].any(axis=1)]
target_ordering = ['native_american',
                   ...
                   'white',
                   'black']
annotator_ordering = ['native_american',
                      'pacific_islander',
                      'middle_eastern',
                      'asian',
                      'latinx',
...
labels = {
    ...
    'latinx': 3,
    'middle_eastern': 4,
    'native_american_pacific_islander': 5,
    'white': 6,
    'other': 7
}
# Label annotator race
data['annotator_race'] = np.where(
    data['annotator_race_native_american'] | data['annotator_race_pacific_islander'],
    labels['native_american_pacific_islander'],
    np.where(
...
data['target_race'] = np.where(
    data['target_race_native_american'] | data['target_race_pacific_islander'],
    labels['native_american_pacific_islander'],
    np.where(
